  ...
  return (
    <section className="flex flex-col lg:flex-row items-center justify-between px-2 md:px-12 lg:px-18    via-[#ffffff] to-[#0033ff]">
      ...
      <div className="lg:w-1/2 text-center lg:text-left space-y-4">
        ...
        <button className="bg-black text-white px-5 py-3 rounded-lg font-semibold mt-1 hover:bg-[#082fca] transition duration-300">
          View Our Services
        </button>
      </div>
      ...
      <div className="lg:w-1/2 mb-10 lg:mt-0 flex justify-center lg:justify-end">
        ...
        <div className="block  mt-15 bg-[#0633e8] p-5 rounded-full shadow-3xl">
          <Image
            src="/hero2.png"
            alt="Mohsin Arshad"
            width={280}
